...
class Function {
	// 함수 : 자주 사용하는 코드를 묶어서 필요할때마다 호출하여 실행할 수 있도록 만든 묶음
...
public class Ex04 {
	public static void main(String[] args) {
		...
		int n1 = 10, n2 = 7;
		int n3 = f.add(n1, n2);		// 함수의 호출(call) 	// f안에 add함수 부르기
									// 함수 이름에 ()를 붙여서 호출한다
									// ()안에는 함수가 처리에 필요한 값을 전달한다
									// ()안에 전달되는 값을 인자라고 한다
							// 외부에서 넘어가는 값을 인자라고 한다

...
class Test4 {
	...
	static int n2 = 20;			// 정적 멤버 필드, 모든 객체가 값을 "공유"하고 변경할 수 있다		// (고)정적 <-> (유)동적
	final int n3 = 30;			// 불변 멤버 필드, 객체마다 다른 값을 가지고 병경할 수 없다
	...
	}							// 메모리에서 static을 먼저 읽어낸다
}								// 그때 non-static은 없기때문에 return n1; 은 실행되지 않는다

public class Ex04 {
	public static void main(String[] args) {
		// final만 지정한 필드는 생성자의 할용에 따라 서로 다른 객체가 다른 값을 가질 수도 있다

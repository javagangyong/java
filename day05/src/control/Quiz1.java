...
public class Quiz1 {
	public static void main(String[] args) {
		...
		int boardCountre;
		int pageCount;	// 수정되어야 함
		
		boardCountre = boardCount % 10;
		if(boardCountre < 10) boardCountre = 1;
		pageCount = boardCount/10 + boardCountre;
...
//		}
		...
		end = page * 10;			// begin을 이용하여 end를 구하는 식
		if(page == pageCount) {
			end = boardCount;
		}
